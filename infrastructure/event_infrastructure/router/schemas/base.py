...
class EntitySchema:
    ...
    def __init__(
        ...
        self.exclude_from_insert = set(exclude_from_insert) if exclude_from_insert else set()
        self.exclude_from_update = set(exclude_from_update) if exclude_from_update else set()
